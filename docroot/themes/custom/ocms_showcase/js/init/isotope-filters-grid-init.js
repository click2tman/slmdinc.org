jQuery(document).ready(function($) {
  ...
  filtersMasonry.prepend( "<li class=\"active\"><a href=\"#\" data-filter=\"*\">" + drupalSettings.ocms_showcase.isotopeFiltersGridInit.isotopeFiltersText + "</a></li>" );
  ...
  masonryContainer.imagesLoaded(function() {
    masonryContainer.isotope({
      ...
      layoutMode : drupalSettings.ocms_showcase.isotopeFiltersGridInit.isotopeLayoutMode,
