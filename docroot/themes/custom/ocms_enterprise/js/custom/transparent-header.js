jQuery(document).ready(function($) {
  ...
  var color = $(".header-container.js-transparent-header header.header").css("background-color").replace(")", "," + drupalSettings.ocms_enterprise.transparentHeader.transparentHeaderOpacity + ")").replace("rgb", "rgba");
