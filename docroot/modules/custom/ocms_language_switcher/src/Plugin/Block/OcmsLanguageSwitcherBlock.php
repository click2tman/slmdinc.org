...
namespace Drupal\ocms_language_switcher\Plugin\Block;
 ...
 *
 * @Block(
 *   id = "ocms_language_switcher",
 *   admin_label = @Translation("OCMS Language switcher"),
 ...
 * )
 */
class PupLanguageSwitcherBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    ...
    foreach (array_keys($links->links) as $link) {
      if (!$node->hasTranslation($link)) {
        unset($links->links[$link]);
      }
    }
